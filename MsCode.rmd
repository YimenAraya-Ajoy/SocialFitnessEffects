...
```{r S1_densityRegulation, cache=TRUE, echo=FALSE}
...
```{r, DensityRegulationFigure, echo=FALSE}
p1.n <- ggplot(df1, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,100) + theme(axis.title.y = element_text(angle = 0, vjust=0.5)) + geom_hline(data=est1, aes(yintercept = EN), colour=cols, linetype="dashed") 
...
```{r S2_Selection, cache=TRUE, echo=FALSE}
...
```{r, SelectionFigure, echo=FALSE}
p2.n <- ggplot(df2, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,100) + theme(axis.title.y = element_text(angle = 0, vjust=0.5)) +  geom_hline(data=est2, aes(yintercept = EN), colour=cols, linetype="dashed") 
...
```{r S3_SocialSelection, cache=TRUE, echo=FALSE}
...
```{r, SocialSelectionFigure, echo=FALSE}
p3.n <- ggplot(df3, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,100) + theme(axis.title.y = element_text(angle = 0, vjust=0.5)) +  geom_hline(data=est3, aes(yintercept = EN), colour=cols, linetype="dashed") 
...
```{r S4_PhenotypeDependentDensityRegulation, cache=TRUE, echo=FALSE}
...
```{r, PhenotypeDependentDensityRegulationFigure, echo=FALSE}
p4.n <- ggplot(df4, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,100) + theme(axis.title.y = element_text(angle = 0, vjust=0.5))  +   geom_hline(data=est4, aes(yintercept = EN), colour=cols, linetype="dashed") 
...
```{r S5_DensityDependentSelection, cache=TRUE, echo=FALSE}
...
```{r, DensityDependentSelectionFigure, echo=FALSE}
p5.n <- ggplot(df5, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,100) + theme(axis.title.y = element_text(angle = 0, vjust=0.5))  +   geom_hline(data=est5, aes(yintercept = EN), colour=cols, linetype="dashed") 
...
```{r S6_FrequencyDependentSelection, cache=TRUE, echo=FALSE}
...
```{r, FrequencyDependentSelectionFigure, echo=FALSE}
p6.n <- ggplot(df6, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,100) + theme(axis.title.y = element_text(angle = 0, vjust=0.5)) +  geom_hline(data=est6, aes(yintercept = EN), colour=cols, linetype="dashed") 
...
```{r S6_FrequencyDensityDependentSelection, cache=TRUE, echo=FALSE}
n.sims = 200
...
```{r, FrequencyDensityDependentSelectionFigure, echo=FALSE}
p7.n <- ggplot(df7, aes(year, Nbar, colour=scenID)) + geom_line(show.legend = FALSE) + scale_color_manual(values=cols) + theme_classic()  + labs(title="A)", x="Year", y = "N") + ylim(0,50) + theme(axis.title.y = element_text(angle = 0, vjust=0.5)) +  geom_hline(data=est7, aes(yintercept = EN), colour=cols, linetype="dashed") 
